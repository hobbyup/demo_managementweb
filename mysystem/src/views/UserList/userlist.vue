...
<div>
    <div class="title-UserList">
        <p class="storg">用户表</p><br>
        <p>平台所有注册用户，可查看详细资料，加入/移除黑名单，以及为用户重新绑卡。</p>
    </div>
    ...
    <div class="filter-container">
      ...
      <el-input v-model="formData.money" placeholder="额度" style="width: 200px;" class="filter-item" @keyup.enter.native="search(formData)" />
    ...
    <el-table-column prop="date" label="注册时间" width="180" sortable>
    </el-table-column>
    <el-table-column prop="finadate" label="最后登录" width="180" sortable>
    </el-table-column>
